...
class IQA_ScoreNormalizer(io.ComfyNode):
    ...
    @classmethod
    def IS_CHANGED(
        cls, input_min, input_max, output_min, output_max, invert, clamp, **kwargs
    ):
        return get_hash([input_min, input_max, output_min, output_max, invert, clamp])

    @classmethod
    def VALIDATE_INPUTS(
        cls, score, input_min, input_max, output_min, output_max, **kwargs
    ):
    ...
    @classmethod
    def execute(
        cls, score, input_min, input_max, output_min, output_max, invert, clamp
    ):
